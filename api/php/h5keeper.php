...
class H5keeper
{
    ...
    // Socket connection to the h5keeper service
    // @var resource
    // @access private
    private $sock;

    // The structure representing the data source of the h5keeper server
    // @var array
    // @access public
    public $dsn;
    ...
    public function __construct($dsn = 'h5keeper://127.0.0.1:9530', $timeout = null)
    {
    ...
    // Flushes the commands in the pipeline queue to h5keeper and returns the responses.
    // @see pipeline
    // @access public
    public function uncork()
    {
        // Open a h5keeper connection and execute the queued commands
